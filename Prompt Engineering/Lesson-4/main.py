...
def reinforcement_learning_activity():
    ...
    improve_response = (f"{initial_response} (Improve with your feedback: {feedback}")
    print(f"\nImprove AI Response: {improve_response}")

    print(f"\nReflection:")
    print("1. How did the model's response improve with feedback?")
    print("2. How fose renforcement learning help AI to improve its performance over time?")
...
def run_activity():
    ...
    if choice == "1":
        ...
        print("Invalied choice. Please choose 1 or 2")
